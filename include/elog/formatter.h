...
{
public:
   static void defaultFormatter(Config* config, context const& ctx,
                                buffer_t& buf, Appenders appenderType);
   static void colorfulFormatter(Config* config, context const& ctx,
                                 buffer_t& buf, Appenders appenderType);
   static void jsonFormatter(Config* config, context const& ctx, buffer_t& buf,
                             Appenders appenderType);
