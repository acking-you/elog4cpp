...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v4.1.0"
  WORKING_DIRECTORY "C:/Users/Alone/CLionProjects/my-logger/cmake-build-release-visual-studio/_deps/nanobench-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Alone/CLionProjects/my-logger/cmake-build-release-visual-studio/_deps/nanobench-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Alone/CLionProjects/my-logger/cmake-build-release-visual-studio/_deps/nanobench-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
